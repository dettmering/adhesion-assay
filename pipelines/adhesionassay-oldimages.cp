...
LoadImages:[module_num:1|svn_version:\'11587\'|variable_revision_number:11|show_window:False|notes:\x5B\'Loading images. Replace "common text" FITC for PI if necessary. In that case, leave the rest as FITC.\'\x5D]
    ...
    Text that these images have in common (case-sensitive):PI
...
IdentifyPrimaryObjects:[module_num:9|svn_version:\'10826\'|variable_revision_number:8|show_window:False|notes:\x5B\'Identify PBL. Thresholding is done very simple by Otsu x 1.5, but should be optimized to mu + 2 sigma thresholding.\', \'Detects PBL from DAPI object size.\'\x5D]
...
MeasureObjectSizeShape:[module_num:10|svn_version:\'1\'|variable_revision_number:1|show_window:False|notes:\x5B\x5D]
    Select objects to measure:EC_Phako
